    ...
    <>
      <footer className="footer footer-center pb-20 px-10 m-0 dark:bg-zinc-800 bg-zinc-100 dark:text-zinc-100 text-zinc-800 relative">
        ...
        <aside className="z-10 relative">
          ...
          <Image src={footer.logo} alt="" width={100} height={100} />
          <p className="font-bold">{footer.name}</p>
          <p>{footer.copyright}</p>
        </aside>
        <nav>
          <div className="grid grid-flow-col gap-4">
            <Link href={footer.links.at(0).href} target="_blank">
              {/* <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              {footer.links.at(0).name}
            </Link>
            <Link href={footer.links.at(1).href} target="_blank">
              {/* <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              {footer.links.at(1).name}
            </Link>
            <Link href={footer.links.at(2).href} target="_blank">
              {/* <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
